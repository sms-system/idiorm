 ...
 * @example Idiorm\String::str_replace_outside_quotes('?', '%s', 'columnA = "Hello?" AND columnB = ?');
 * @example Idiorm\String::value('columnA = "Hello?" AND columnB = ?')->replace_outside_quotes('?', '%s');
